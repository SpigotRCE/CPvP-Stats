package io.github.spigotrce.cpvpstats.listener;

import io.github.spigotrce.cpvpstats.CPvP;
...
public abstract class PaperListener implements Listener {
     ...
     */
    public PaperListener(CPvP plugin, Server server, Logger logger) {
